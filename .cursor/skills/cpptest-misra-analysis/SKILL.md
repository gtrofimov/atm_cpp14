...
```bash
./.cursor/skills/cpptest-misra-analysis/run-misra-analysis.sh --branch \
...
./.cursor/skills/cpptest-misra-analysis/run-misra-analysis.sh

# Modified files only - all violations
./.cursor/skills/cpptest-misra-analysis/run-misra-analysis.sh --branch

# Full project - new violations only (vs origin/main)
./.cursor/skills/cpptest-misra-analysis/run-misra-analysis.sh --new-violations

# Modified files - new violations only (the ultimate check)
./.cursor/skills/cpptest-misra-analysis/run-misra-analysis.sh --branch --new-violations

# Against different branch
./.cursor/skills/cpptest-misra-analysis/run-misra-analysis.sh --branch --ref-branch origin/develop

# Local working tree changes only
./.cursor/skills/cpptest-misra-analysis/run-misra-analysis.sh --local

# Local changes with new violations only
./.cursor/skills/cpptest-misra-analysis/run-misra-analysis.sh --local --new-violations
